...
"""Converts Rail data to TFRecord file format with Example protos."""
...
tf.app.flags.DEFINE_string(
    'train_image_folder',
    './RailData4-1-mn/RailData4-1-mn/images/training',
    'Folder containing trainng images')
tf.app.flags.DEFINE_string(
    'train_image_label_folder',
    './RailData4-1-mn/RailData4-1-mn/annotations/training',
    'Folder containing annotations for trainng images')

tf.app.flags.DEFINE_string(
    'val_image_folder',
    './RailData4-1-mn/RailData4-1-mn/images/validation',
    'Folder containing validation images')

tf.app.flags.DEFINE_string(
    'val_image_label_folder',
    './RailData4-1-mn/RailData4-1-mn/annotations/validation',
    'Folder containing annotations for validation')

tf.app.flags.DEFINE_string(
    'output_dir', './RailData4-1-mn/tfrecord',
...
def _convert_dataset(dataset_split, dataset_dir, dataset_label_dir):
  """Converts the RailData4-1-mn dataset into into tfrecord format.
