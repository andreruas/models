...
tf.app.flags.DEFINE_string(
    'train_image_folder',
    './RailData2-1/RailData2-1/images/training',
    'Folder containing trainng images')
tf.app.flags.DEFINE_string(
    'train_image_label_folder',
    './RailData2-1/RailData2-1/annotations/training',
    'Folder containing annotations for trainng images')

tf.app.flags.DEFINE_string(
    'val_image_folder',
    './RailData2-1/RailData2-1/images/validation',
    'Folder containing validation images')

tf.app.flags.DEFINE_string(
    'val_image_label_folder',
    './RailData2-1/RailData2-1/annotations/validation',
    'Folder containing annotations for validation')

tf.app.flags.DEFINE_string(
    'output_dir', './RailData2-1/tfrecord',
...
def _convert_dataset(dataset_split, dataset_dir, dataset_label_dir):
  """Converts the RailData2-1 dataset into into tfrecord format.
