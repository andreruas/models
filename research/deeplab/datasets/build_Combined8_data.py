...
tf.app.flags.DEFINE_string(
    'train_image_folder',
    './Combined8-1-mn/Combined8-1-mn/images/training',
    'Folder containing trainng images')
tf.app.flags.DEFINE_string(
    'train_image_label_folder',
    './Combined8-1-mn/Combined8-1-mn/annotations/training',
    'Folder containing annotations for trainng images')

tf.app.flags.DEFINE_string(
    'val_image_folder',
    './Combined8-1-mn/Combined8-1-mn/images/validation',
    'Folder containing validation images')

tf.app.flags.DEFINE_string(
    'val_image_label_folder',
    './Combined8-1-mn/Combined8-1-mn/annotations/validation',
    'Folder containing annotations for validation')

tf.app.flags.DEFINE_string(
    'output_dir', './Combined8-1-mn/tfrecord',
...
def _convert_dataset(dataset_split, dataset_dir, dataset_label_dir):
  """Converts the Combined8-1-mn dataset into into tfrecord format.
